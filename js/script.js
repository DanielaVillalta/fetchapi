//URL de la API
const API_URL = "https://retoolapi.dev/XTl7JY/data";

//Función que manda a traer el JSON
//async: indica que esta función es asincrónica, es decir, puede contener operaciones que esperan resultados que tardan un poco (como una llamada a una API).
...
async function EliminarPersona(id) {
    const confirmacion = confirm("¿Está seguro de que deseas eliminar el registro?");
